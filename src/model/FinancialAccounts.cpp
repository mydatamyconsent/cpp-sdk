...
bool FinancialAccounts::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("required_details"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<FinancialAccountDetailsRequired>> refVal_setRequiredDetails;
            ok &= ModelBase::fromJson(fieldValue, refVal_setRequiredDetails);
            setRequiredDetails(refVal_setRequiredDetails);
        }
    }
...
bool FinancialAccounts::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        std::vector<std::shared_ptr<FinancialAccountDetailsRequired>> refVal_setRequiredDetails;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("required_details"))), refVal_setRequiredDetails );
        setRequiredDetails(refVal_setRequiredDetails);
    }
