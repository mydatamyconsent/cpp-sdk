...
#include "MyDataMyConsent/model/UserAccountFinancialTransactionsDtoPaginatedList.h"
...
UserAccountFinancialTransactionsDtoPaginatedList::UserAccountFinancialTransactionsDtoPaginatedList()
{
    m_PageIndex = 0;
...
void UserAccountFinancialTransactionsDtoPaginatedList::validate()
{
    // TODO: implement validation
}

web::json::value UserAccountFinancialTransactionsDtoPaginatedList::toJson() const
{
...
bool UserAccountFinancialTransactionsDtoPaginatedList::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("items"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<UserAccountFinancialTransactionsDto>> refVal_setItems;
...
void UserAccountFinancialTransactionsDtoPaginatedList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UserAccountFinancialTransactionsDtoPaginatedList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t UserAccountFinancialTransactionsDtoPaginatedList::getPageIndex() const
{
    return m_PageIndex;
}

void UserAccountFinancialTransactionsDtoPaginatedList::setPageIndex(int32_t value)
{
    m_PageIndex = value;
    m_PageIndexIsSet = true;
}

bool UserAccountFinancialTransactionsDtoPaginatedList::pageIndexIsSet() const
{
    return m_PageIndexIsSet;
}

void UserAccountFinancialTransactionsDtoPaginatedList::unsetPageIndex()
{
    m_PageIndexIsSet = false;
}
int32_t UserAccountFinancialTransactionsDtoPaginatedList::getPageSize() const
{
    return m_PageSize;
}

void UserAccountFinancialTransactionsDtoPaginatedList::setPageSize(int32_t value)
{
    m_PageSize = value;
    m_PageSizeIsSet = true;
}

bool UserAccountFinancialTransactionsDtoPaginatedList::pageSizeIsSet() const
{
    return m_PageSizeIsSet;
}

void UserAccountFinancialTransactionsDtoPaginatedList::unsetPageSize()
{
    m_PageSizeIsSet = false;
}
int32_t UserAccountFinancialTransactionsDtoPaginatedList::getTotalPages() const
{
    return m_TotalPages;
}

void UserAccountFinancialTransactionsDtoPaginatedList::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool UserAccountFinancialTransactionsDtoPaginatedList::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void UserAccountFinancialTransactionsDtoPaginatedList::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
int64_t UserAccountFinancialTransactionsDtoPaginatedList::getTotalItems() const
{
    return m_TotalItems;
}

void UserAccountFinancialTransactionsDtoPaginatedList::setTotalItems(int64_t value)
{
    m_TotalItems = value;
    m_TotalItemsIsSet = true;
}

bool UserAccountFinancialTransactionsDtoPaginatedList::totalItemsIsSet() const
{
    return m_TotalItemsIsSet;
}

void UserAccountFinancialTransactionsDtoPaginatedList::unsetTotalItems()
{
    m_TotalItemsIsSet = false;
}
std::vector<std::shared_ptr<UserAccountFinancialTransactionsDto>>& UserAccountFinancialTransactionsDtoPaginatedList::getItems()
{
    return m_Items;
}

void UserAccountFinancialTransactionsDtoPaginatedList::setItems(const std::vector<std::shared_ptr<UserAccountFinancialTransactionsDto>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}

bool UserAccountFinancialTransactionsDtoPaginatedList::itemsIsSet() const
{
    return m_ItemsIsSet;
}

void UserAccountFinancialTransactionsDtoPaginatedList::unsetItems()
{
    m_ItemsIsSet = false;
}
}
