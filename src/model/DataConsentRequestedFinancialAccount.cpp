...
#include "MyDataMyConsent/model/DataConsentRequestedFinancialAccount.h"
...
bool DataConsentRequestedFinancialAccount::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("drn"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_setDrn;
            ok &= ModelBase::fromJson(fieldValue, refVal_setDrn);
            setDrn(refVal_setDrn);
        }
    }
    ...
    if(val.has_field(utility::conversions::to_string_t(U("accountIdentifier"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_setAccountIdentifier;
            ok &= ModelBase::fromJson(fieldValue, refVal_setAccountIdentifier);
            setAccountIdentifier(refVal_setAccountIdentifier);
        }
    }
    return ok;
}
...
bool DataConsentRequestedFinancialAccount::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        utility::string_t refVal_setDrn;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("drn"))), refVal_setDrn );
        setDrn(refVal_setDrn);
    }
    ...
    {
        utility::string_t refVal_setAccountIdentifier;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("accountIdentifier"))), refVal_setAccountIdentifier );
        setAccountIdentifier(refVal_setAccountIdentifier);
    }
    return ok;
}
