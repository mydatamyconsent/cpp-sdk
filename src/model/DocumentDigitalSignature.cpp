...
bool DocumentDigitalSignature::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("issuedBy"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_setIssuedBy;
            ok &= ModelBase::fromJson(fieldValue, refVal_setIssuedBy);
            setIssuedBy(refVal_setIssuedBy);
        }
    }
    ...
    if(val.has_field(utility::conversions::to_string_t(U("validToUtc"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::datetime refVal_setValidToUtc;
            ok &= ModelBase::fromJson(fieldValue, refVal_setValidToUtc);
            setValidToUtc(refVal_setValidToUtc);
        }
    }
    return ok;
}
...
bool DocumentDigitalSignature::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        utility::string_t refVal_setIssuedBy;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("issuedBy"))), refVal_setIssuedBy );
        setIssuedBy(refVal_setIssuedBy);
    }
    ...
    {
        utility::datetime refVal_setValidToUtc;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("validToUtc"))), refVal_setValidToUtc );
        setValidToUtc(refVal_setValidToUtc);
    }
    return ok;
}
