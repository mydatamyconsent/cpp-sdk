...
bool CreateDataConsentRequest::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("consentTemplateId"))))
    {
        ...
        {
            utility::string_t refVal_setConsentTemplateId;
            ok &= ModelBase::fromJson(fieldValue, refVal_setConsentTemplateId);
            setConsentTemplateId(refVal_setConsentTemplateId);
        }
    }
...
bool CreateDataConsentRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        utility::string_t refVal_setConsentTemplateId;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("consentTemplateId"))), refVal_setConsentTemplateId );
        setConsentTemplateId(refVal_setConsentTemplateId);
    }
