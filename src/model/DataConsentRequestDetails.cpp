...
#include "MyDataMyConsent/model/DataConsentRequestDetails.h"
...
void DataConsentRequestDetails::validate()
{
    // TODO: implement validation
}

web::json::value DataConsentRequestDetails::toJson() const
{
...
bool DataConsentRequestDetails::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DataConsentRequestDetails::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
utility::string_t DataConsentRequestDetails::getId() const
{
    return m_Id;
}

void DataConsentRequestDetails::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool DataConsentRequestDetails::idIsSet() const
{
    return m_IdIsSet;
}

void DataConsentRequestDetails::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t DataConsentRequestDetails::getTemplateId() const
{
    return m_TemplateId;
}

void DataConsentRequestDetails::setTemplateId(const utility::string_t& value)
{
    m_TemplateId = value;
    m_TemplateIdIsSet = true;
}

bool DataConsentRequestDetails::templateIdIsSet() const
{
...
void DataConsentRequestDetails::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool DataConsentRequestDetails::titleIsSet() const
{
    return m_TitleIsSet;
}

void DataConsentRequestDetails::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t DataConsentRequestDetails::getDescription() const
{
    return m_Description;
}

void DataConsentRequestDetails::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool DataConsentRequestDetails::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void DataConsentRequestDetails::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t DataConsentRequestDetails::getPurpose() const
{
    return m_Purpose;
}

void DataConsentRequestDetails::setPurpose(const utility::string_t& value)
{
    m_Purpose = value;
    m_PurposeIsSet = true;
}

bool DataConsentRequestDetails::purposeIsSet() const
{
    return m_PurposeIsSet;
}

void DataConsentRequestDetails::unsetPurpose()
{
    m_PurposeIsSet = false;
}
std::shared_ptr<DataConsentStatus> DataConsentRequestDetails::getStatus() const
{
    return m_Status;
}

void DataConsentRequestDetails::setStatus(const std::shared_ptr<DataConsentStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool DataConsentRequestDetails::statusIsSet() const
{
    return m_StatusIsSet;
}

void DataConsentRequestDetails::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t DataConsentRequestDetails::getTransactionId() const
{
    return m_TransactionId;
}

void DataConsentRequestDetails::setTransactionId(const utility::string_t& value)
{
    m_TransactionId = value;
    m_TransactionIdIsSet = true;
}

bool DataConsentRequestDetails::transactionIdIsSet() const
{
    return m_TransactionIdIsSet;
}

void DataConsentRequestDetails::unsetTransactionId()
{
    m_TransactionIdIsSet = false;
}
utility::datetime DataConsentRequestDetails::getCreatedAtUtc() const
{
    return m_CreatedAtUtc;
}

void DataConsentRequestDetails::setCreatedAtUtc(const utility::datetime& value)
{
    m_CreatedAtUtc = value;
    m_CreatedAtUtcIsSet = true;
}

bool DataConsentRequestDetails::createdAtUtcIsSet() const
{
