...
bool Identifier::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("exampleValue"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_setExampleValue;
            ok &= ModelBase::fromJson(fieldValue, refVal_setExampleValue);
            setExampleValue(refVal_setExampleValue);
        }
    }
    return ok;
}
...
bool Identifier::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        utility::string_t refVal_setExampleValue;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("exampleValue"))), refVal_setExampleValue );
        setExampleValue(refVal_setExampleValue);
    }
    return ok;
}
