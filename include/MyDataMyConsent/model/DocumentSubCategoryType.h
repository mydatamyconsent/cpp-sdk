...
/*
 * DocumentSubCategoryType.h
 *
 * 
 */

#ifndef MYDATAMYCONSENT_MODELS_DocumentSubCategoryType_H_
#define MYDATAMYCONSENT_MODELS_DocumentSubCategoryType_H_
...
public:
    ...
    virtual ~DocumentSubCategoryType();
    ...
    void setValue(eDocumentSubCategoryType const value);

    protected:
        eDocumentSubCategoryType m_value;
};

}
}

#endif /* MYDATAMYCONSENT_MODELS_DocumentSubCategoryType_H_ */
