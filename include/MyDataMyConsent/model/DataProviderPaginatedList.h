...
/*
 * DataProviderPaginatedList.h
 *
 * 
 */

#ifndef MYDATAMYCONSENT_MODELS_DataProviderPaginatedList_H_
#define MYDATAMYCONSENT_MODELS_DataProviderPaginatedList_H_
...
public:
    ...
    virtual ~DataProviderPaginatedList();
    ...
    /////////////////////////////////////////////
    /// DataProviderPaginatedList members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<DataProvider>>& getItems();
    bool itemsIsSet() const;
    void unsetItems();

    void setItems(const std::vector<std::shared_ptr<DataProvider>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<DataProvider>> m_Items;
    bool m_ItemsIsSet;
};
...
#endif /* MYDATAMYCONSENT_MODELS_DataProviderPaginatedList_H_ */
