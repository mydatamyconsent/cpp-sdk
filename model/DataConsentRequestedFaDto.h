...
/*
 * DataConsentRequestedFaDto.h
 *
 * 
 */

#ifndef MYDATAMYCONSENT_MODELS_DataConsentRequestedFaDto_H_
#define MYDATAMYCONSENT_MODELS_DataConsentRequestedFaDto_H_


#include "ModelBase.h"

#include "model/FinancialAccountTypes.h"
#include "model/DataConsentRfaFilterDto.h"
...
public:
    ...
    virtual ~DataConsentRequestedFaDto();
    ...
    /////////////////////////////////////////////
    /// DataConsentRequestedFaDto members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<DataConsentRfaFilterDto>>& getFilters();
    bool filtersIsSet() const;
    void unsetFilters();

    void setFilters(const std::vector<std::shared_ptr<DataConsentRfaFilterDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<DataConsentRfaFilterDto>> m_Filters;
    bool m_FiltersIsSet;
};
...
#endif /* MYDATAMYCONSENT_MODELS_DataConsentRequestedFaDto_H_ */
