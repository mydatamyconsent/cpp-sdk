...
bool UriDetails::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("aadhaar"))))
    {
        ...
        {
            utility::string_t refVal_aadhaar;
            ok &= ModelBase::fromJson(fieldValue, refVal_aadhaar);
            setAadhaar(refVal_aadhaar);
        }
    }
    ...
    if(val.has_field(utility::conversions::to_string_t(U("docType"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_docType;
            ok &= ModelBase::fromJson(fieldValue, refVal_docType);
            setDocType(refVal_docType);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("docName"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_docName;
            ok &= ModelBase::fromJson(fieldValue, refVal_docName);
            setDocName(refVal_docName);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("docId"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_docId;
            ok &= ModelBase::fromJson(fieldValue, refVal_docId);
            setDocId(refVal_docId);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("issuedOn"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_issuedOn;
            ok &= ModelBase::fromJson(fieldValue, refVal_issuedOn);
            setIssuedOn(refVal_issuedOn);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("validFrom"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_validFrom;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("validTo"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_validTo;
            ok &= ModelBase::fromJson(fieldValue, refVal_validTo);
            setValidTo(refVal_validTo);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("timestamp"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_timestamp;
...
bool UriDetails::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        utility::string_t refVal_aadhaar;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("aadhaar"))), refVal_aadhaar );
        setAadhaar(refVal_aadhaar);
    }
    ...
    {
        utility::string_t refVal_docType;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("docType"))), refVal_docType );
        setDocType(refVal_docType);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("docName"))))
    {
        utility::string_t refVal_docName;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("docName"))), refVal_docName );
        setDocName(refVal_docName);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("docId"))))
    {
        utility::string_t refVal_docId;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("docId"))), refVal_docId );
        setDocId(refVal_docId);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("issuedOn"))))
    {
        utility::string_t refVal_issuedOn;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("issuedOn"))), refVal_issuedOn );
        setIssuedOn(refVal_issuedOn);
    }
    ...
    {
        utility::string_t refVal_validTo;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("validTo"))), refVal_validTo );
        setValidTo(refVal_validTo);
    }
