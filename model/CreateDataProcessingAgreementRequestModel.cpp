...
#include "CreateDataProcessingAgreementRequestModel.h"
...
void CreateDataProcessingAgreementRequestModel::validate()
{
    // TODO: implement validation
}

web::json::value CreateDataProcessingAgreementRequestModel::toJson() const
{
...
bool CreateDataProcessingAgreementRequestModel::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateDataProcessingAgreementRequestModel::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateDataProcessingAgreementRequestModel::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t CreateDataProcessingAgreementRequestModel::getVersion() const
{
    return m_Version;
}

void CreateDataProcessingAgreementRequestModel::setVersion(const utility::string_t& value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool CreateDataProcessingAgreementRequestModel::versionIsSet() const
{
    return m_VersionIsSet;
}

void CreateDataProcessingAgreementRequestModel::unsetVersion()
{
    m_VersionIsSet = false;
}
utility::string_t CreateDataProcessingAgreementRequestModel::getBody() const
{
    return m_Body;
}

void CreateDataProcessingAgreementRequestModel::setBody(const utility::string_t& value)
{
    m_Body = value;
    m_BodyIsSet = true;
}

bool CreateDataProcessingAgreementRequestModel::bodyIsSet() const
{
    return m_BodyIsSet;
}

void CreateDataProcessingAgreementRequestModel::unsetBody()
{
    m_BodyIsSet = false;
}
utility::string_t CreateDataProcessingAgreementRequestModel::getAttachmentUrl() const
{
    return m_AttachmentUrl;
}

void CreateDataProcessingAgreementRequestModel::setAttachmentUrl(const utility::string_t& value)
{
    m_AttachmentUrl = value;
    m_AttachmentUrlIsSet = true;
}

bool CreateDataProcessingAgreementRequestModel::attachmentUrlIsSet() const
{
    return m_AttachmentUrlIsSet;
}

void CreateDataProcessingAgreementRequestModel::unsetAttachmentUrl()
{
    m_AttachmentUrlIsSet = false;
}
}
