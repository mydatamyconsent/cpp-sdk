...
#include "DataProcessingAgreementDto.h"
...
DataProcessingAgreementDto::DataProcessingAgreementDto()
{
...
void DataProcessingAgreementDto::validate()
{
    // TODO: implement validation
}

web::json::value DataProcessingAgreementDto::toJson() const
{
...
bool DataProcessingAgreementDto::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DataProcessingAgreementDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DataProcessingAgreementDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t DataProcessingAgreementDto::getId() const
{
    return m_Id;
}

void DataProcessingAgreementDto::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool DataProcessingAgreementDto::idIsSet() const
{
    return m_IdIsSet;
}

void DataProcessingAgreementDto::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t DataProcessingAgreementDto::getVersion() const
{
    return m_Version;
}

void DataProcessingAgreementDto::setVersion(const utility::string_t& value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool DataProcessingAgreementDto::versionIsSet() const
{
    return m_VersionIsSet;
}

void DataProcessingAgreementDto::unsetVersion()
{
    m_VersionIsSet = false;
}
utility::string_t DataProcessingAgreementDto::getBody() const
{
    return m_Body;
}

void DataProcessingAgreementDto::setBody(const utility::string_t& value)
{
    m_Body = value;
    m_BodyIsSet = true;
}

bool DataProcessingAgreementDto::bodyIsSet() const
{
    return m_BodyIsSet;
}

void DataProcessingAgreementDto::unsetBody()
{
    m_BodyIsSet = false;
}
utility::string_t DataProcessingAgreementDto::getAttachmentUrl() const
{
    return m_AttachmentUrl;
}

void DataProcessingAgreementDto::setAttachmentUrl(const utility::string_t& value)
{
    m_AttachmentUrl = value;
    m_AttachmentUrlIsSet = true;
}

bool DataProcessingAgreementDto::attachmentUrlIsSet() const
{
    return m_AttachmentUrlIsSet;
}

void DataProcessingAgreementDto::unsetAttachmentUrl()
{
    m_AttachmentUrlIsSet = false;
}
}
