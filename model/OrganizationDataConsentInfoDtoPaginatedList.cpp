...
#include "OrganizationDataConsentInfoDtoPaginatedList.h"
...
OrganizationDataConsentInfoDtoPaginatedList::OrganizationDataConsentInfoDtoPaginatedList()
{
    m_PageIndex = 0;
...
void OrganizationDataConsentInfoDtoPaginatedList::validate()
{
    // TODO: implement validation
}

web::json::value OrganizationDataConsentInfoDtoPaginatedList::toJson() const
{
...
bool OrganizationDataConsentInfoDtoPaginatedList::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("items"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<OrganizationDataConsentInfoDto>> refVal_items;
...
void OrganizationDataConsentInfoDtoPaginatedList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool OrganizationDataConsentInfoDtoPaginatedList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t OrganizationDataConsentInfoDtoPaginatedList::getPageIndex() const
{
    return m_PageIndex;
}

void OrganizationDataConsentInfoDtoPaginatedList::setPageIndex(int32_t value)
{
    m_PageIndex = value;
    m_PageIndexIsSet = true;
}

bool OrganizationDataConsentInfoDtoPaginatedList::pageIndexIsSet() const
{
    return m_PageIndexIsSet;
}

void OrganizationDataConsentInfoDtoPaginatedList::unsetPageIndex()
{
    m_PageIndexIsSet = false;
}
int32_t OrganizationDataConsentInfoDtoPaginatedList::getPageSize() const
{
    return m_PageSize;
}

void OrganizationDataConsentInfoDtoPaginatedList::setPageSize(int32_t value)
{
    m_PageSize = value;
    m_PageSizeIsSet = true;
}

bool OrganizationDataConsentInfoDtoPaginatedList::pageSizeIsSet() const
{
    return m_PageSizeIsSet;
}

void OrganizationDataConsentInfoDtoPaginatedList::unsetPageSize()
{
    m_PageSizeIsSet = false;
}
int32_t OrganizationDataConsentInfoDtoPaginatedList::getTotalPages() const
{
    return m_TotalPages;
}

void OrganizationDataConsentInfoDtoPaginatedList::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool OrganizationDataConsentInfoDtoPaginatedList::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void OrganizationDataConsentInfoDtoPaginatedList::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
int64_t OrganizationDataConsentInfoDtoPaginatedList::getTotalItems() const
{
    return m_TotalItems;
}

void OrganizationDataConsentInfoDtoPaginatedList::setTotalItems(int64_t value)
{
    m_TotalItems = value;
    m_TotalItemsIsSet = true;
}

bool OrganizationDataConsentInfoDtoPaginatedList::totalItemsIsSet() const
{
    return m_TotalItemsIsSet;
}

void OrganizationDataConsentInfoDtoPaginatedList::unsetTotalItems()
{
    m_TotalItemsIsSet = false;
}
std::vector<std::shared_ptr<OrganizationDataConsentInfoDto>>& OrganizationDataConsentInfoDtoPaginatedList::getItems()
{
    return m_Items;
}

void OrganizationDataConsentInfoDtoPaginatedList::setItems(const std::vector<std::shared_ptr<OrganizationDataConsentInfoDto>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}

bool OrganizationDataConsentInfoDtoPaginatedList::itemsIsSet() const
{
    return m_ItemsIsSet;
}

void OrganizationDataConsentInfoDtoPaginatedList::unsetItems()
{
    m_ItemsIsSet = false;
}
}
