...
#include "CreateIndividualDataConsentRequest.h"
...
void CreateIndividualDataConsentRequest::validate()
{
    // TODO: implement validation
}

web::json::value CreateIndividualDataConsentRequest::toJson() const
{
...
bool CreateIndividualDataConsentRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateIndividualDataConsentRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateIndividualDataConsentRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t CreateIndividualDataConsentRequest::getConsentTemplateId() const
{
    return m_ConsentTemplateId;
}

void CreateIndividualDataConsentRequest::setConsentTemplateId(const utility::string_t& value)
{
    m_ConsentTemplateId = value;
    m_ConsentTemplateIdIsSet = true;
}

bool CreateIndividualDataConsentRequest::consentTemplateIdIsSet() const
{
    return m_ConsentTemplateIdIsSet;
}

void CreateIndividualDataConsentRequest::unsetConsentTemplateId()
{
    m_ConsentTemplateIdIsSet = false;
}
...
bool CreateIndividualDataConsentRequest::receiverIsSet() const
{
    return m_ReceiverIsSet;
}

void CreateIndividualDataConsentRequest::unsetReceiver()
{
    m_ReceiverIsSet = false;
}
}
