...
#include "IndividualDataConsentDetailsPaginatedList.h"
...
IndividualDataConsentDetailsPaginatedList::IndividualDataConsentDetailsPaginatedList()
{
    m_PageIndex = 0;
...
void IndividualDataConsentDetailsPaginatedList::validate()
{
    // TODO: implement validation
}

web::json::value IndividualDataConsentDetailsPaginatedList::toJson() const
{
...
bool IndividualDataConsentDetailsPaginatedList::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("items"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<IndividualDataConsentDetails>> refVal_items;
...
void IndividualDataConsentDetailsPaginatedList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool IndividualDataConsentDetailsPaginatedList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t IndividualDataConsentDetailsPaginatedList::getPageIndex() const
{
    return m_PageIndex;
}

void IndividualDataConsentDetailsPaginatedList::setPageIndex(int32_t value)
{
    m_PageIndex = value;
    m_PageIndexIsSet = true;
}

bool IndividualDataConsentDetailsPaginatedList::pageIndexIsSet() const
{
    return m_PageIndexIsSet;
}

void IndividualDataConsentDetailsPaginatedList::unsetPageIndex()
{
    m_PageIndexIsSet = false;
}
int32_t IndividualDataConsentDetailsPaginatedList::getPageSize() const
{
    return m_PageSize;
}

void IndividualDataConsentDetailsPaginatedList::setPageSize(int32_t value)
{
    m_PageSize = value;
    m_PageSizeIsSet = true;
}

bool IndividualDataConsentDetailsPaginatedList::pageSizeIsSet() const
{
    return m_PageSizeIsSet;
}

void IndividualDataConsentDetailsPaginatedList::unsetPageSize()
{
    m_PageSizeIsSet = false;
}
int32_t IndividualDataConsentDetailsPaginatedList::getTotalPages() const
{
    return m_TotalPages;
}

void IndividualDataConsentDetailsPaginatedList::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool IndividualDataConsentDetailsPaginatedList::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void IndividualDataConsentDetailsPaginatedList::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
int64_t IndividualDataConsentDetailsPaginatedList::getTotalItems() const
{
    return m_TotalItems;
}

void IndividualDataConsentDetailsPaginatedList::setTotalItems(int64_t value)
{
    m_TotalItems = value;
    m_TotalItemsIsSet = true;
}

bool IndividualDataConsentDetailsPaginatedList::totalItemsIsSet() const
{
    return m_TotalItemsIsSet;
}

void IndividualDataConsentDetailsPaginatedList::unsetTotalItems()
{
    m_TotalItemsIsSet = false;
}
std::vector<std::shared_ptr<IndividualDataConsentDetails>>& IndividualDataConsentDetailsPaginatedList::getItems()
{
    return m_Items;
}

void IndividualDataConsentDetailsPaginatedList::setItems(const std::vector<std::shared_ptr<IndividualDataConsentDetails>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}

bool IndividualDataConsentDetailsPaginatedList::itemsIsSet() const
{
    return m_ItemsIsSet;
}

void IndividualDataConsentDetailsPaginatedList::unsetItems()
{
    m_ItemsIsSet = false;
}
}
