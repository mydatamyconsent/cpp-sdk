...
#include "OrganizationDataConsentRequestDetailsPaginatedList.h"
...
OrganizationDataConsentRequestDetailsPaginatedList::OrganizationDataConsentRequestDetailsPaginatedList()
{
    m_PageIndex = 0;
...
void OrganizationDataConsentRequestDetailsPaginatedList::validate()
{
    // TODO: implement validation
}

web::json::value OrganizationDataConsentRequestDetailsPaginatedList::toJson() const
{
...
bool OrganizationDataConsentRequestDetailsPaginatedList::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("items"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<OrganizationDataConsentRequestDetails>> refVal_items;
...
void OrganizationDataConsentRequestDetailsPaginatedList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool OrganizationDataConsentRequestDetailsPaginatedList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t OrganizationDataConsentRequestDetailsPaginatedList::getPageIndex() const
{
    return m_PageIndex;
}

void OrganizationDataConsentRequestDetailsPaginatedList::setPageIndex(int32_t value)
{
    m_PageIndex = value;
    m_PageIndexIsSet = true;
}

bool OrganizationDataConsentRequestDetailsPaginatedList::pageIndexIsSet() const
{
    return m_PageIndexIsSet;
}

void OrganizationDataConsentRequestDetailsPaginatedList::unsetPageIndex()
{
    m_PageIndexIsSet = false;
}
int32_t OrganizationDataConsentRequestDetailsPaginatedList::getPageSize() const
{
    return m_PageSize;
}

void OrganizationDataConsentRequestDetailsPaginatedList::setPageSize(int32_t value)
{
    m_PageSize = value;
    m_PageSizeIsSet = true;
}

bool OrganizationDataConsentRequestDetailsPaginatedList::pageSizeIsSet() const
{
    return m_PageSizeIsSet;
}

void OrganizationDataConsentRequestDetailsPaginatedList::unsetPageSize()
{
    m_PageSizeIsSet = false;
}
int32_t OrganizationDataConsentRequestDetailsPaginatedList::getTotalPages() const
{
    return m_TotalPages;
}

void OrganizationDataConsentRequestDetailsPaginatedList::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool OrganizationDataConsentRequestDetailsPaginatedList::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void OrganizationDataConsentRequestDetailsPaginatedList::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
int64_t OrganizationDataConsentRequestDetailsPaginatedList::getTotalItems() const
{
    return m_TotalItems;
}

void OrganizationDataConsentRequestDetailsPaginatedList::setTotalItems(int64_t value)
{
    m_TotalItems = value;
    m_TotalItemsIsSet = true;
}

bool OrganizationDataConsentRequestDetailsPaginatedList::totalItemsIsSet() const
{
    return m_TotalItemsIsSet;
}

void OrganizationDataConsentRequestDetailsPaginatedList::unsetTotalItems()
{
    m_TotalItemsIsSet = false;
}
std::vector<std::shared_ptr<OrganizationDataConsentRequestDetails>>& OrganizationDataConsentRequestDetailsPaginatedList::getItems()
{
    return m_Items;
}

void OrganizationDataConsentRequestDetailsPaginatedList::setItems(const std::vector<std::shared_ptr<OrganizationDataConsentRequestDetails>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}

bool OrganizationDataConsentRequestDetailsPaginatedList::itemsIsSet() const
{
    return m_ItemsIsSet;
}

void OrganizationDataConsentRequestDetailsPaginatedList::unsetItems()
{
    m_ItemsIsSet = false;
}
}
