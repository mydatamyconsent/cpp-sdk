...
#include "DataProcessingAgreementDtoPaginatedList.h"
...
DataProcessingAgreementDtoPaginatedList::DataProcessingAgreementDtoPaginatedList()
{
    m_PageIndex = 0;
...
void DataProcessingAgreementDtoPaginatedList::validate()
{
    // TODO: implement validation
}

web::json::value DataProcessingAgreementDtoPaginatedList::toJson() const
{
...
bool DataProcessingAgreementDtoPaginatedList::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("items"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<DataProcessingAgreementDto>> refVal_items;
...
void DataProcessingAgreementDtoPaginatedList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DataProcessingAgreementDtoPaginatedList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t DataProcessingAgreementDtoPaginatedList::getPageIndex() const
{
    return m_PageIndex;
}

void DataProcessingAgreementDtoPaginatedList::setPageIndex(int32_t value)
{
    m_PageIndex = value;
    m_PageIndexIsSet = true;
}

bool DataProcessingAgreementDtoPaginatedList::pageIndexIsSet() const
{
    return m_PageIndexIsSet;
}

void DataProcessingAgreementDtoPaginatedList::unsetPageIndex()
{
    m_PageIndexIsSet = false;
}
int32_t DataProcessingAgreementDtoPaginatedList::getPageSize() const
{
    return m_PageSize;
}

void DataProcessingAgreementDtoPaginatedList::setPageSize(int32_t value)
{
    m_PageSize = value;
    m_PageSizeIsSet = true;
}

bool DataProcessingAgreementDtoPaginatedList::pageSizeIsSet() const
{
    return m_PageSizeIsSet;
}

void DataProcessingAgreementDtoPaginatedList::unsetPageSize()
{
    m_PageSizeIsSet = false;
}
int32_t DataProcessingAgreementDtoPaginatedList::getTotalPages() const
{
    return m_TotalPages;
}

void DataProcessingAgreementDtoPaginatedList::setTotalPages(int32_t value)
{
    m_TotalPages = value;
    m_TotalPagesIsSet = true;
}

bool DataProcessingAgreementDtoPaginatedList::totalPagesIsSet() const
{
    return m_TotalPagesIsSet;
}

void DataProcessingAgreementDtoPaginatedList::unsetTotalPages()
{
    m_TotalPagesIsSet = false;
}
int64_t DataProcessingAgreementDtoPaginatedList::getTotalItems() const
{
    return m_TotalItems;
}

void DataProcessingAgreementDtoPaginatedList::setTotalItems(int64_t value)
{
    m_TotalItems = value;
    m_TotalItemsIsSet = true;
}

bool DataProcessingAgreementDtoPaginatedList::totalItemsIsSet() const
{
    return m_TotalItemsIsSet;
}

void DataProcessingAgreementDtoPaginatedList::unsetTotalItems()
{
    m_TotalItemsIsSet = false;
}
std::vector<std::shared_ptr<DataProcessingAgreementDto>>& DataProcessingAgreementDtoPaginatedList::getItems()
{
    return m_Items;
}

void DataProcessingAgreementDtoPaginatedList::setItems(const std::vector<std::shared_ptr<DataProcessingAgreementDto>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}

bool DataProcessingAgreementDtoPaginatedList::itemsIsSet() const
{
    return m_ItemsIsSet;
}

void DataProcessingAgreementDtoPaginatedList::unsetItems()
{
    m_ItemsIsSet = false;
}
}
