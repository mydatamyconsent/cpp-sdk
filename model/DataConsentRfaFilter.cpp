...
#include "DataConsentRfaFilter.h"
...
void DataConsentRfaFilter::validate()
{
    // TODO: implement validation
}

web::json::value DataConsentRfaFilter::toJson() const
{
...
bool DataConsentRfaFilter::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DataConsentRfaFilter::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DataConsentRfaFilter::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<FilterType> DataConsentRfaFilter::getFilterType() const
{
    return m_FilterType;
}

void DataConsentRfaFilter::setFilterType(const std::shared_ptr<FilterType>& value)
{
    m_FilterType = value;
    m_FilterTypeIsSet = true;
}

bool DataConsentRfaFilter::filterTypeIsSet() const
{
    return m_FilterTypeIsSet;
}

void DataConsentRfaFilter::unsetFilterType()
{
    m_FilterTypeIsSet = false;
}
std::shared_ptr<Operator> DataConsentRfaFilter::getROperator() const
{
    return m_r_operator;
}

void DataConsentRfaFilter::setROperator(const std::shared_ptr<Operator>& value)
{
    m_r_operator = value;
    m_r_operatorIsSet = true;
}

bool DataConsentRfaFilter::rOperatorIsSet() const
{
    return m_r_operatorIsSet;
}

void DataConsentRfaFilter::unsetr_operator()
{
    m_r_operatorIsSet = false;
}
utility::string_t DataConsentRfaFilter::getValue() const
{
    return m_Value;
}

void DataConsentRfaFilter::setValue(const utility::string_t& value)
{
    m_Value = value;
    m_ValueIsSet = true;
}

bool DataConsentRfaFilter::valueIsSet() const
{
    return m_ValueIsSet;
}

void DataConsentRfaFilter::unsetValue()
{
    m_ValueIsSet = false;
}
}
