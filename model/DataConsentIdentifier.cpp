...
#include "DataConsentIdentifier.h"
...
void DataConsentIdentifier::validate()
{
    // TODO: implement validation
}

web::json::value DataConsentIdentifier::toJson() const
{
...
bool DataConsentIdentifier::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DataConsentIdentifier::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DataConsentIdentifier::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t DataConsentIdentifier::getKey() const
{
    return m_Key;
}

void DataConsentIdentifier::setKey(const utility::string_t& value)
{
    m_Key = value;
    m_KeyIsSet = true;
}

bool DataConsentIdentifier::keyIsSet() const
{
    return m_KeyIsSet;
}

void DataConsentIdentifier::unsetKey()
{
    m_KeyIsSet = false;
}
utility::string_t DataConsentIdentifier::getValue() const
{
    return m_Value;
}

void DataConsentIdentifier::setValue(const utility::string_t& value)
{
    m_Value = value;
    m_ValueIsSet = true;
}

bool DataConsentIdentifier::valueIsSet() const
{
    return m_ValueIsSet;
}

void DataConsentIdentifier::unsetValue()
{
    m_ValueIsSet = false;
}
}
