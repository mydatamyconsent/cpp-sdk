...
std::shared_ptr<ConsentRequestReceiver> CreateOrganizationDataConsentRequest::getReceiver() const
{
    return m_Receiver;
}

void CreateOrganizationDataConsentRequest::setReceiver(const std::shared_ptr<ConsentRequestReceiver>& value)
{
    m_Receiver = value;
